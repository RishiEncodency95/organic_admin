...
export const defaultLandingSections: LandingSectionContent[] = [
  ...
  },
  {
    ...
    items: [
      { title: "Organic Food & Beverages", description: "Certified organic staples, grains, healthy snacks, and juices." },
      { title: "AYUSH, Ayurveda & Herbal", description: "Ayurvedic medicines, supplements, teas, and herbal solutions." },
      { title: "Natural Farming & Bio-Inputs", description: "Bio-fertilizers, organic seeds, manures, and pest management." },
      { title: "Natural Beauty & Personal Care", description: "Eco-friendly skincare, vegan cosmetics, and personal hygiene." },
      { title: "AgriTech & Green Innovations", description: "Smart farming technology, irrigation, and processing machines." },
      { title: "Sustainable Packaging", description: "Biodegradable, eco-friendly, and recyclable packaging materials." },
    ],
  },
  {
