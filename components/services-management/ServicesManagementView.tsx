...
type ServiceCategory = "Stall Allocation" | "B2B Lounge" | "Pavilions" | "Sponsorship";

type Service = {
  id: number; name: string; description: string; category: ServiceCategory;
  status: "Published" | "Draft"; views: number; requests: number; image: string;
  serviceIcon: typeof Truck; iconTone: string;
};

const SERVICES: Service[] = [
  { id: 1, name: "Exhibitor Stall Booking", description: "Standard & Bare space stall allocation for organic producers & brands.", category: "Stall Allocation", status: "Published", views: 856, requests: 312, image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=300&q=80", serviceIcon: Truck, iconTone: "bg-emerald-50 text-emerald-600" },
  { id: 2, name: "B2B Trade Buyer Lounge", description: "VIP Buyer-Seller matchmaking, delegation entry & networking lounge.", category: "B2B Lounge", status: "Published", views: 1024, requests: 428, image: "https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=300&q=80", serviceIcon: Flame, iconTone: "bg-orange-50 text-orange-500" },
  { id: 3, name: "State & Farmer Pavilion", description: "Special subsidised pavilion for organic state boards & farmer co-ops.", category: "Pavilions", status: "Published", views: 642, requests: 198, image: "https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=300&q=80", serviceIcon: Flower2, iconTone: "bg-violet-50 text-violet-600" },
  { id: 4, name: "Corporate Sponsorship & Branding", description: "Plenary session, lanyards, main gate & digital branding packages.", category: "Sponsorship", status: "Published", views: 726, requests: 218, image: "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?auto=format&fit=crop&w=300&q=80", serviceIcon: HeartHandshake, iconTone: "bg-emerald-50 text-emerald-600" },
  { id: 5, name: "Organic Farm Machinery Zone", description: "Outdoor display zone for eco-friendly farming tools & bio-inputs.", category: "Pavilions", status: "Published", views: 312, requests: 96, image: "https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=300&q=80", serviceIcon: Amphora, iconTone: "bg-indigo-50 text-indigo-600" },
  { id: 6, name: "Organic Certification Workshop", description: "Technical seminars & NPOP certification guidance for growers.", category: "Sponsorship", status: "Draft", views: 156, requests: 32, image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=300&q=80", serviceIcon: FileText, iconTone: "bg-slate-100 text-slate-600" },
  { id: 7, name: "Organic Food Court & Tasting", description: "Stalls for organic food tasting & live culinary demonstrations.", category: "Stall Allocation", status: "Published", views: 201, requests: 48, image: "https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&w=300&q=80", serviceIcon: Box, iconTone: "bg-slate-100 text-emerald-700" },
];

const categoryTone: Record<ServiceCategory, string> = {
  "Stall Allocation": "bg-blue-50 text-blue-600",
  "B2B Lounge": "bg-orange-50 text-orange-600",
  "Pavilions": "bg-violet-50 text-violet-600",
  "Sponsorship": "bg-emerald-50 text-emerald-600"
};
