        ...
        <div className="mt-2 grid items-start gap-1.5 xl:grid-cols-[minmax(0,1.55fr)_minmax(350px,1fr)]">
          <Section number={1} title="Service Information" note="Provide the basic details of the service.">
            <div className="space-y-3.5">
              ...
              <Field label="Service Slug (URL)" required hint="Use lowercase letters, numbers and hyphens only."><div className="flex"><span className="flex h-10 shrink-0 items-center rounded-l-lg border border-r-0 border-slate-200 bg-slate-50 px-3 text-[10.5px] text-slate-500">https://bharatorganicexpo.com/services/</span><input value={slug} onChange={(e) => setSlug(e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, ""))} placeholder="enter-service-slug" className={`${fieldClass} rounded-l-none`} /></div></Field>
